    ...
    @section('content')
        <div class="relative flex items-top justify-center bg-white dark:bg-gray-900 sm:items-center mt-8"> 
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <h2 class="text-center" style="font-size:30px">Visayas State University - Integrated High School</h2>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 ml-auto">
                        <div class="p-6 border-gray-200 dark:border-gray-700">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="row mb-3">
                                    <label for="enrollmentnumber" class="col-md-4 col-form-label text-md-end">{{ __('Enrollment Control Number') }}</label>

                                    <div class="col-md-6">
                                        <input id="enrollmentnumber" type="text" class="form-control @error('firstname') is-invalid @enderror" name="enrollmentnumber" value="{{ old('enrollmentnumber') }}" required autocomplete="enrollmentnumber" autofocus>
